...
public class CoralL2 extends SequentialCommandGroup {
  ...
  public CoralL2(ElevatorSubsystem elevator, CoralArms coralArm, CoralRotator rotator, ConnectorX lights) {
    addCommands(
      lights.c_elevator2Lights()
        .alongWith(new InstantCommand(() -> elevator.v_setpoint(30)))
