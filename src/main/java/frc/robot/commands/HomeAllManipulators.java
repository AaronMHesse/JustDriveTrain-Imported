...
public class HomeAllManipulators extends SequentialCommandGroup {

  public HomeAllManipulators(ElevatorSubsystem elevator, CoralArms coralArm, CoralRotator rotator, AlgaeArms algaeArm, CTRE_CANdle m_CANdle) {
    addCommands(
      new InstantCommand(() -> m_CANdle.v_L1())
        .alongWith(new InstantCommand(() -> elevator.v_setpoint(0)))
          .alongWith(new InstantCommand(() -> coralArm.v_setpoint(0)))
            .alongWith(new InstantCommand(() -> rotator.v_clawHome()))
