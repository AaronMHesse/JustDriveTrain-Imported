...
public class CoralL4 extends SequentialCommandGroup {
  ...
  public CoralL4(ElevatorSubsystem elevator, CoralArms coralArm, CoralRotator rotator, CTRE_CANdle m_CANdle) {
    addCommands(
      new InstantCommand(() -> m_CANdle.v_L4())
        .alongWith(new InstantCommand(() -> elevator.v_setpoint(45)))
